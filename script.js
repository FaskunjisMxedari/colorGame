...
clickBox.forEach(box =>{
  box.addEventListener("click", (event) =>{
    ...
    if(clicked.style.backgroundColor===document.querySelector("#genesisBox").style.backgroundColor){
      generate()
      score++
      number.innerHTML = score
      if(score>0){
...
function boxClick(numb){
  ...
  // let a = "#box" + chooser
  // console.log(a)
  document.querySelector("#box" + chooser).style.backgroundColor = document.querySelector("#genesisBox").style.backgroundColor
}
